 ...
 */
module.exports = provider => function checkClaims(ctx, next) {
  const params = ctx.oidc.params;

  if (params.claims !== undefined && provider.enabled('features.claimsParameter')) {
  ...
  if (!ctx.oidc.claims) ctx.oidc.claims = {};
